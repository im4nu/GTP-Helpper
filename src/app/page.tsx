        ...
        <div className="flex flex-col w-[calc(100vw-260px)] h-full items-center justify-evenly lg:px-[2.5vw] xl:px-[5vw] 2xl:px-[10vw]">
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <h2 className="text-xs text-white-200 w-2/3 text-center">
              Simplifique suas tarefas e alcance o sucesso de forma rápida e
              fácil com nosso Software de Comandos Inteligentes. Experimente
              agora mesmo e veja como tudo pode ser mais simples e eficiente!
            </h2>
          </div>
          ...
          <div className="flex flex-col items-start w-full gap-2">
            ...
            <input
              type="text"
              placeholder="“ Como utilizar o GPT Hellper? =) ”"
              className="flex w-full bg-white rounded-lg p-2 text-dark"
            />
          </div>
        </div>
      </div>
